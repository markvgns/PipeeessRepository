...
typedef struct process_control_block
{
  ...
  rlnode ptcb_list; /**< @brief The list of threads that are attached to this process*/
  int thread_count; /**< @brief number of threads attached to this process*/
...
/**
  @brief connecting the new_tcb (thread) to a ptcb

    Initialize the PTCB's list node that will be used going in the list

    Add the PTCB to the process's thread list
*/

void add_tcb_to_process(PCB *process, TCB *main_tcb);
